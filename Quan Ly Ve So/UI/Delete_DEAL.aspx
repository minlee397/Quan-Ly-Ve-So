<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Delete_Deal.aspx.cs" Inherits="Quan_Ly_Ve_So.UI.Delete_Deal" %>
            ...
            <div class="col-sm-7 delete_content">
                ...
                <div class="row delete_footer">
                    <div class="col-sm-12">
                        ...
                        <a href="Deal.aspx" class="btn btn-default">Trở về</a>
                    </div>
                </div>
            </div>
        </div>
