<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Delete_SignUp_Lottery.aspx.cs" Inherits="Quan_Ly_Ve_So.UI.Delete_SignUp_Lottery" %>
            ...
            <div class="col-sm-7 delete_content">
                ...
                <div class="row delete_footer">
                    <div class="col-sm-12">
                        ...
                        <a href="SignUp_Lottery.aspx" class="btn btn-default">Trở về</a>
                    </div>
                </div>
            </div>
        </div>
