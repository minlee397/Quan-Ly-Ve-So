                            ...
                            <div class="modal-body">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        <asp:Label ID="NameAgency" runat="server" Text="Tên Đại Lý: " CssClass="control-label col-sm-2 col-lg-2"></asp:Label>
                                        <div class="col-sm-6 col-lg-6">
                                            <asp:TextBox ID="input_NameAgency" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <asp:Label ID="Addr" runat="server" Text="Địa Chỉ: " CssClass="control-label col-sm-2 col-lg-2"></asp:Label>
                                        <div class="col-sm-6 col-lg-6">
                                            <asp:TextBox ID="input_Addr" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <asp:Label ID="Numphone" runat="server" Text="Số Điện Thoại: " CssClass="control-label col-sm-2 col-lg-2"></asp:Label>
                                        <div class="col-sm-6 col-lg-6">
                                            <asp:TextBox ID="input_Numphone" runat="server" CssClass="form-control"></asp:TextBox>     
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <asp:Label ID="Activate" runat="server" Text="Tình Trạng: " CssClass="control-label col-sm-2 col-lg-2"></asp:Label>
                                        <div class="col-sm-6 col-lg-6">
                                             <asp:RadioButtonList ID="rdo_Activate" runat="server" RepeatColumns = "2" RepeatDirection="Vertical" RepeatLayout="Table" >
                                                <asp:ListItem Value="1" Selected>Hoạt động</asp:ListItem>
